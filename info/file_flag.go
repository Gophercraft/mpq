...
const (
	...
	FileReplaceExisting FileFlag = 0x80000000 // Replace when the file exist (SFileAddFile)
...
func (flag FileFlag) String() string {
	...
	if flag&FileReplaceExisting != 0 {
		readout = append(readout, "replace when the file exists")
	}
